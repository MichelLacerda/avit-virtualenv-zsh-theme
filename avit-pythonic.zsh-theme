# AVIT ZSH Theme
# AVIT ZSH THEME PYTHONIC
#
# Customized it by Michel Lacerda
# GitHub project https://github.com/MichelLacerda/avit-virtualenv-zsh-theme

export VIRTUAL_ENV_DISABLE_PROMPT=yes

PROMPT='${_command_u} $(_user_host)${_current_dir} $(git_prompt_info) $(_ruby_version)
${_command_d}$(_virtualenv_name)${_command_line} '
